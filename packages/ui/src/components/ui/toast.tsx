...
const ToastClose = ({ className, ref, ...props }: ComponentProps<typeof ToastPrimitives.Close>) => (
...
const ToastTitle = ({ className, ref, ...props }: ComponentProps<typeof ToastPrimitives.Title>) => (
